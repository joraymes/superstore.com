...
class order {
    ...
    public function get($id){
        $sql="SELECT tbl_orders.*, tbl_customers.code as clientcode, tbl_customers.name
            FROM tbl_orders
    ...
    public function insert($data){
        ...
        $sql="INSERT INTO tbl_orders  (".implode(",",$fields).") VALUES (".implode(",",$values)."); ";
    ...
    public function update($id , $data){
        ...
        $sql="UPDATE tbl_orders SET ".implode(",", $fields)." WHERE id=$id ;";
