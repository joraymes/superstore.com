...
class country {
    ...
    public function get($id){
        $sql="SELECT tbl_countries.*
            FROM tbl_countries
            
            WHERE tbl_countries.id=$id    ";
    ...
    public function insert($data){
        ...
        $sql="INSERT INTO tbl_countries  (".implode(",",$fields).") VALUES (".implode(",",$values)."); ";
    ...
    public function update($id , $data){
        ...
        $sql="UPDATE tbl_countries SET ".implode(",", $fields)." WHERE id=$id ;";
    ...
    public function delete($id){
        ...
        $sql="DELETE FROM tbl_countries  WHERE id=$id ;";
        switch($this->returnType){
            case 'json' :
