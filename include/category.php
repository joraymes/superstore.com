...
class category {
    ...
    public function get($id){
        $sql="SELECT tbl_categories.*, cat.category as rootCategory
            FROM tbl_categories
            LEFT JOIN tbl_categories as cat ON cat.id=tbl_categories.id_categories
    ...
    public function insert($data){
        ...
        $sql="INSERT INTO tbl_categories  (".implode(",",$fields).") VALUES (".implode(",",$values)."); ";
    ...
    public function update($id , $data){
        ...
        $sql="UPDATE tbl_categories SET ".implode(",", $fields)." WHERE id=$id ;";
