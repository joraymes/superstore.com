...
class product {
    ...
    public function get($id){
        $sql="SELECT tbl_products.*, tbl_categories.category
            FROM tbl_products
    ...
    public function insert($data){
        ...
        $sql="INSERT INTO tbl_products  (".implode(",",$fields).") VALUES (".implode(",",$values)."); ";
    ...
    public function update($id , $data){
        ...
        $sql="UPDATE tbl_products SET ".implode(",", $fields)." WHERE id=$id ;";
