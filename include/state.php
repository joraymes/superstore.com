...
class state {
    ...
    public function insert($data){
        ...
        $sql="INSERT INTO tbl_states  (".implode(",",$fields).") VALUES (".implode(",",$values)."); ";
    ...
    public function update($id , $data){
        ...
        $sql="UPDATE tbl_states SET ".implode(",", $fields)." WHERE id=$id ;";
    ...
    public function delete($id){
        ...
        $sql="DELETE FROM tbl_states  WHERE id=$id ;";
        switch($this->returnType){
            case 'json' :
