...
class city {
    ...
    public function get($id){
        $sql="SELECT tbl_cities.*, tbl_regions.region, tbl_states.state, tbl_countries.country 
            FROM tbl_cities
    ...
    public function insert($data){
        ...
        $sql="INSERT INTO tbl_cities  (".implode(",",$fields).") VALUES (".implode(",",$values)."); ";
    ...
    public function update($id , $data){
        ...
        $sql="UPDATE tbl_cities SET ".implode(",", $fields)." WHERE id=$id ;";
    ...
    public function delete($id){
        ...
        $sql="DELETE FROM tbl_cities  WHERE id=$id ;";
        switch($this->returnType){
            case 'json' :
